...
session_start();
    ...
    $selling_history_query = "select * from lands where buyer_name != ''";
    ...
    <div class="container d-flex align-items-center">
      ...
      <nav class="nav-menu d-none d-lg-block">
        <ul>
          ...
          <li class="active"><a href="admin-lands.php">Purchased Lands</a></li>
                ...
                <tbody>
                    ...
                    ?>
                        ...
                        <tr>
                            ...
                            <td>0<?php echo $row['buyer_phone'] ?></td>
                            <td><?php echo $row['seller_name'] ?></td>
                            <td>0<?php echo $row['seller_phone'] ?></td>
