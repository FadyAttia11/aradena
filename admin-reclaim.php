...
session_start();
    ...
    $selling_history_query = "select * from reclaimations where investor_name != ''";
    ...
    <div class="container d-flex align-items-center">
      ...
      <nav class="nav-menu d-none d-lg-block">
        <ul>
          ...
          <li class="active"><a href="admin-reclaim.php">Reclaimations</a></li>
                ...
                <tbody>
                    ...
                    ?>
                        ...
                        <tr>
                            ...
                            <td><?php echo $row['land_area'] ?> Acre</td>
                            <td><?php echo $row['money'] ?> L.E</td>
